...
#include "./Executes/TessTriangleDistance.h"
#include "./Executes/TessRect.h"
#include "./Executes/TessRectDistance.h"
...
Program::Program()
{
	...
	//executes.push_back(new TessTriangleDistance);
	//executes.push_back(new TessRect);
	executes.push_back(new TessRectDistance);
}
