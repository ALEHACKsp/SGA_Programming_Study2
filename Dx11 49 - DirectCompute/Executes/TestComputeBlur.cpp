#include "stdafx.h"
#include "TestComputeBlur.h"

#include "./Environment/Sky.h"

TestComputeBlur::TestComputeBlur()
{
	sky = new Sky();
...
void TestComputeBlur::Update()
{
	sky->Update();
	bunny->Update();
}

void TestComputeBlur::PreRender()
{
...
void TestComputeBlur::PostRender()
{
