...
void DirectWrite::RenderText(string text, RECT rect, float size, wstring font, D3DXCOLOR color, DWRITE_FONT_WEIGHT weight, DWRITE_FONT_STYLE style, DWRITE_FONT_STRETCH stretch)
{
	RenderText(String::ToWString(text), rect, size, font, color, weight, style, stretch);
}
