	...
	:Execute(values)
{
	...
	//exporter->ExportMaterial(Materials + L"/Meshes/", L"Capsule2.material");
	//exporter->ExportMesh(Models + L"/Meshes/", L"Capsule2.mesh");
	//SAFE_DELETE(exporter);

	// Sphere2
	//exporter = new Fbx::Exporter(Assets + L"Meshes/Sphere.fbx");
	//exporter->ExportMaterial(Materials + L"/Meshes/", L"Sphere2.material");
	//exporter->ExportMesh(Models + L"/Meshes/", L"Sphere2.mesh");
	//SAFE_DELETE(exporter);
