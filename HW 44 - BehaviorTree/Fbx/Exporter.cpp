...
void Fbx::Exporter::ExportAnimation(wstring saveFloder, wstring fileName, UINT clipNumber)
{
...
void Fbx::Exporter::ExportAnimation(wstring saveFloder, wstring fileName, wstring clipName)
{
