...
void Context::SetView(D3DXMATRIX view)
{
	perFrame.View = view;
...
D3DXMATRIX Context::GetView()
{
	return perFrame.View;
}

void Context::SetProjection(D3DXMATRIX projection)
{
	this->projection.Project = projection;
...
D3DXMATRIX Context::GetProjection()
{
