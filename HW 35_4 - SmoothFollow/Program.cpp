...
Program::Program()
{
	...
	// fpos mod test
	//{
	//	float ans = Math::FPosMod(-7, 10);
	//	int a = 10;
	//}

	// normal angle test
	{
		float angle = Math::NormalizeAngle(-3.14);
		float angle2 = Math::NormalizeAngle(10);
		float angle3 = Math::NormalizeAngle(1.75f);
		int a = 10;
	}
...
{
	// lerpAngle test
	angle1 = Math::LerpAngle(angle1, angle2, Time::Delta());
