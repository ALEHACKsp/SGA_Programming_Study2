...
public:
	...
	D3DXVECTOR3 Direction(
		class Viewport * vp, class Perspective* perspective);

	virtual void SetTarget(D3DXVECTOR3& targetPos) {};
	virtual void SetTarget(D3DXVECTOR3& targetPos, D3DXVECTOR3& targetRot, D3DXVECTOR3& targetUp) {};
