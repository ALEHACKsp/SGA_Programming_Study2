...
void Program::PostRender()
{
	...
	wstring str = L""
		L"후비적, 킁킁\n"
		L"키스의 고유 조건은 입술끼리 만나야하고, 다른 어떤 기술도 필요치 않다\n"
		L"Seoul Game Academy\n"
		L"金泰勳"
		L"ㄱㄴㄷㄻㅂ 뷁";

	RECT rect = { 100, 100, 1024, 768 };
	DirectWrite::Get()->RenderText(str, rect, 30, L"궁서체");

	str = L"테스트2";
	rect = { 500,500, 1024,768 };
	DirectWrite::Get()->RenderText(str, rect, 30, L"돋움체", D3DXCOLOR(1, 0, 0, 1));
}
