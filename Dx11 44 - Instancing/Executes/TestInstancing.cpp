	...
	:Execute(values)
{
	...
	texture[2] = new Texture(Textures + L"Dirt.png");
	texture[3] = new Texture(Textures + L"Dirt2.png");
	texture[4] = new Texture(Textures + L"Dirt3.png");
	texture[5] = new Texture(Textures + L"Wall.png");
}
