...
public:
	...
	static D3DXVECTOR3 Transform(D3DXVECTOR3 position, D3DXMATRIX matrix);

	static void Transform(D3DXVECTOR3& position, D3DXMATRIX& matrix, OUT D3DXVECTOR3& result);
	static void Transform(D3DXVECTOR3& value, D3DXQUATERNION& rotation, OUT D3DXVECTOR3& result);
};