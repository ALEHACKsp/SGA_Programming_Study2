...
#include "./Executes/ExDebugDraw.h"
...
Program::Program()
{
	...
	values->MainCamera->RotationDegree(19.91f, 25.23f);
	values->MainCamera->Position(-17.49f, 38.96f, -54.70f);
	...
	executes.push_back(new ExDebugDraw(values));

	((ExDebugDraw*)executes.back())->SetTerrain(
		((DrawLandScape*)executes[0])->GetTerrain());

	// 19.91f, 25.23f
	// -17.49f, 38.96f, -54.70f
}
