...
void Water::Render()
{
	// ImGui
	{
		...
		ImGui::Text("VS");
		// VS
		ImGui::DragFloat("WaveFrequency", &vsBuffer->Data.WaveFrequency, 0.1f);
		ImGui::DragFloat("WaveAmplitude", &vsBuffer->Data.WaveAmplitude, 0.1f);

		ImGui::DragFloat2("BumpSpeed", (float*)&vsBuffer->Data.BumpSpeed, 0.1f);
		ImGui::DragFloat("BumpHeight", &vsBuffer->Data.BumpHeight, 0.1f);
		
		ImGui::Separator();
		ImGui::Text("PS");

		ImGui::ColorEdit4("ShallowColor", (float*)&psBuffer->Data.ShallowColor);
		ImGui::ColorEdit4("DeepColor", (float*)&psBuffer->Data.DeepColor);
		...
		ImGui::DragFloat("ShoreBlend", &psBuffer->Data.ShoreBlend, 0.1f);

		ImGui::DragFloat("HeightRatio", &psBuffer->Data.HeightRatio);
