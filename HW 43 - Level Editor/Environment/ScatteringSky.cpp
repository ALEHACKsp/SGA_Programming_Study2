	...
	, radius(10), slices(32), stacks(16)
{
	...
	cloudsShader->AsShaderResource("CloudsMap")->SetResource(perlinNoiseSrv);
	...
	scatterShader->AsShaderResource("StarMap")->SetResource(starMap->SRV());
	scatterShader->AsShaderResource("RayleighMap")->SetResource(rayLeighTarget->SRV());
	scatterShader->AsShaderResource("MieMap")->SetResource(mieTarget->SRV());

	scatterShader->AsShaderResource("RayleighMap")->SetResource(rayLeighTarget->SRV());
	scatterShader->AsShaderResource("MieMap")->SetResource(mieTarget->SRV());

	moonMap = new Texture(Textures + L"Moon.png");
	moonShader->AsShaderResource("MoonMap")->SetResource(moonMap->SRV());
	moonglowMap = new Texture(Textures + L"Moonglow.png");
	moonShader->AsShaderResource("GlowMap")->SetResource(moonglowMap->SRV());
